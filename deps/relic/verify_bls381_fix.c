...
// Include RELIC - using the non-prefixed version
#define RELIC_LABEL ""
#include "relic.h"

int main() {
    printf("========================================\n");
    printf("RELIC 0.7.0 BLS12-381 Fix Verification\n");
    printf("========================================\n\n");

    // Test 1: Initialize RELIC
    printf("[Test 1] RELIC Core Initialization\n");
    if (core_init() != RLC_OK) {
        printf("❌ FAILED: core_init returned error\n");
        return 1;
    }
    printf("✅ PASSED: RELIC core initialized\n\n");
    ...
    printf("✅ PASSED: Pairing-friendly curve selected\n");
    ...
    printf("========================================\n");
    printf("Summary: BLS12-381 Fix Verification\n");
    printf("========================================\n");
    printf("✅ All basic tests PASSED\n");
    printf("✅ BLS12-381 curve is functional\n");
    printf("✅ No ERR_NO_PRECI errors\n");
    printf("✅ No initialization failures\n");
    printf("\n🎉 RELIC 0.7.0 BLS12-381 FIX VERIFIED! 🎉\n\n");
